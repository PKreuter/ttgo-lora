...
PROGMEM const char* MQTT_PUB_GW_ONLINE = "lora/gateway/bb/online";
PROGMEM const char* MQTT_PUB_GW_LIVENESS = "lora/gateway/bb/liveness";
PROGMEM const char* MQTT_PUB_GW_RSSI = "lora/gateway/bb/rssi/wifi";
PROGMEM const char* MQTT_PUB_GW_EVENTS = "lora/gateway/bb/events";
